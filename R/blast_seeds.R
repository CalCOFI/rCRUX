...
#'
#' @param seeds_path a path to a csv from get_seeds_local or get_seeds_remote
...
#' @return NULL
#' @export
blast_seeds <- function(seeds_path, blast_db_path, accession_taxa_sql_path, working_dir,
